...
void MD5Hash_SIMD(const string inputs[4], bit32 states[4][4]) {
    ...
    uint32_t h0[4] = {0x67452301, 0x67452301, 0x67452301, 0x67452301};
    uint32_t h1[4] = {0xefcdab89, 0xefcdab89, 0xefcdab89, 0xefcdab89};
    uint32_t h2[4] = {0x98badcfe, 0x98badcfe, 0x98badcfe, 0x98badcfe};
    uint32_t h3[4] = {0x10325476, 0x10325476, 0x10325476, 0x10325476};
    uint32x4_t state0 = vld1q_u32(h0);
    uint32x4_t state1 = vld1q_u32(h1);
    uint32x4_t state2 = vld1q_u32(h2);
    uint32x4_t state3 = vld1q_u32(h3);
