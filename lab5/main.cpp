...
// mpic++ main.cpp train.cpp guessing.cpp md5.cpp -o main -O2 -fopenmp -std=c++11


// mpic++ main.cpp train.cpp guessing.cpp md5.cpp -o main -fopenmp -std=c++11
// bash test.sh 3 1 4


// mpic++ main.cpp train.cpp guessing.cpp md5.cpp -o main -lpthread -std=c++11
// bash test.sh 2 1 4
